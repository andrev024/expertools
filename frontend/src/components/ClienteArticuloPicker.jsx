...
function ClienteArticuloPicker({ onArticuloSeleccionado }) {
  ...
  async function eliminarCliente(cliente) {
    ...
    if (!window.confirm(`¿Eliminar a ${nombreMostrar}? Esto también borrará sus artículos, órdenes, cotizaciones e historial. Esta acción no se puede deshacer.`)) return;
    setError('');
